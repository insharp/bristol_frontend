...
const MeasurementFieldManagement: React.FC<MeasurementFieldManagementProps> = ({
  ...
  const handleUpdateMeasurementField = async () => {
    ...
    try {
      ...
      //  Update existing fields (matching by index)
      ...
      for (let i = 0; i < minLength; i++) {
        ...
        if (hasChanged) {
          const updateData = {
            ...
            is_required: String(formField.is_required)
          };
      ...
      //  Create new fields (if form has more fields than existing)
      ...
      // Delete removed fields (if existing has more fields than form)
            ...
            <SlideModal isOpen={isModalOpen} onClose={closeModal} title={getModalTitle()}>
              <form onSubmit={handleSubmit} className="p-6 space-y-6 flex flex-col h-full">
                ...
                <div className="space-y-4 flex flex-col flex-1 min-h-0">
                    ...
                    {formData.fields.map((field, index) => {
                      ...
                      return (
                        <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                          ...
                          <div 
                            className="flex justify-between items-center px-4 py-2 bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors"
                  ...
                  {formErrors.fields && (
                    <p className="mt-1 text-sm text-red-600 flex-shrink-0">{formErrors.fields}</p>
                  )}
                </div>
        ...
        {modalMode === "view" && selectedMeasurementFieldGroup && (
          <SlideModal isOpen={isModalOpen} onClose={closeModal} title={getModalTitle()}>
            <div className="flex flex-col h-full">
              ...
              <div className="flex-shrink-0 flex pt-4 gap-4 border-t border-gray-200 px-6 pb-6 bg-white">
            ...
            <div className="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Delete Measurement Fields</h3>
                </div>
